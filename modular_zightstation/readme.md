# The modularization handbook - Nightstation style
...
```diff
- var/something = 1
+ var/something = 2 //NIGHTSTATION EDIT
```
...
And then you'll want to establish your core folder that you'll be working out of which is normally your module ID. E.g. `modular_nightstation/modules/shuttle_toggle`
...
DO NOT CHANGE TG OR SKYRAT MAPS, THEY ARE HELD TO THE SAME STANDARD AS ICONS. USE THE ABOVE TO MAKE MAP EDITS.
...
- ***Example:*** You're adding a new lavaland mob.
  ...
  First of all you create your modular folder. E.g. `modular_nightstation/modules/lavalandmob`
  ...
  ```byond
    /mob/lavaland/newmob
      icon = 'modular_nightstation/modules/lavalandmob/icons/mob.dmi'
      icon_state = "dead_1"
      sound = 'modular_nightstation/modules/lavalandmob/sounds/boom.ogg'
  ```
...
Example: `code/modules/mob/living/living.dm` -> `modular_nightstation/master_files/code/modules/mob/living/living.dm`
...
In short, most of the modular code will be placed in the subfolders of your main module folder **`modular_nightstation/modules/yourmodule/code/`**, with similar rules as with the assets. Do not mirror core code folder structures inside your modular folder.

For example, `modular_nightstation/modules/xenoarcheaology/code` containing all the code, tools, items and machinery related to it.
...
- **Addition:**
  ...
  ```byond
  //NIGHTSTATION EDIT ADDITION BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
  var/adminEmergencyNoRecall = FALSE
  var/lastMode = SHUTTLE_IDLE
  var/lastCallTime = 6000
  //NIGHTSTATION EDIT ADDITION END
  ```

- **Removal:**

  ```byond
  //NIGHTSTATION EDIT REMOVAL BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
  /*
  ...
  */
  ...
  ```byond
  //NIGHTSTATION EDIT REMOVAL BEGIN - SHUTTLE_TOGGLE - (Moved to modular_nightstation/shuttle_toggle/randomverbs.dm)
  /*
...
- **Change:**
  ...
  ```byond
  //NIGHTSTATION EDIT CHANGE BEGIN - SHUTTLE_TOGGLE - (Optional Reason/comment)
  //if(SHUTTLE_STRANDED, SHUTTLE_ESCAPE) - NIGHTSTATION EDIT - ORIGINAL
  if(SHUTTLE_STRANDED, SHUTTLE_ESCAPE, SHUTTLE_DISABLED)
  //NIGHTSTATION EDIT CHANGE END
      return 1
  ```
...
That folder is **`code/__DEFINES/~nightstation_defines`**, in which you can add them to the existing files, or create those files as necessary.
...
- Good: /modular_nightstation/modules/example_module/code/disease_mob.dm
- Bad: /modular_nightstation/modules/example_module/code/modules/antagonists/disease/disease_mob.dm

**Icons**: Any .DMI files must go in here.

- Good: /modular_nightstation/modules/example_module/icons/mining_righthand.dmi
- Bad: /modular_nightstation/modules/example_module/icons/mob/inhands/equipment/mining_righthand.dmi
...
If you are removing redundant MODULAR code, do not comment it out. Delete it.
